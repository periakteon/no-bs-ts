...
/*****************************************/
[1, 2, 3, 4, 5].forEach(function (n) { return console.log(n); });
[6, 7, 8, 9, 10].map(function (n) { return console.log(n); });
var out = [6, 7, 8, 9, 10].map(function (n) { return n * 10; });
var out2 = [6, 7, 8, 9, 10].map(function (n) { return n * 10; });
// template string kullandığımız için string array olur.
var outButAsString = [6, 7, 8, 9, 10].map(function (n) { return "".concat(n * 10); });
var outButAsString2 = [6, 7, 8, 9, 10].map(function (n) { return "".concat(n * 10); });
